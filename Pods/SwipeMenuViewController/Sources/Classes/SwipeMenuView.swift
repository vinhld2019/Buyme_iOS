...
public struct SwipeMenuViewOptions {
    ...
    public struct TabView {
        ...
        public struct AdditionView {
            ...
            public var padding: UIEdgeInsets = UIEdgeInsets(top: 10, left: 10, bottom: 10, right: 10)//UIEdgeInsets(top: 10, left: (UIScreen.main.bounds.width / 4) - 10, bottom: 10, right: (UIScreen.main.bounds.width / 4) - 10)
...
open class SwipeMenuView: UIView {
    ...
    /// Vinh LD
    var addition: SwipeMenuViewOptions.TabView.Addition = .circle
    /// End Vinh LD
    ...
    private func setup(default defaultIndex: Int = 0) {
        ...
        var tabViewOptions = options.tabView
        tabViewOptions.addition = self.addition
        tabView = TabView(frame: CGRect(x: 0, y: 0, width: frame.width, height: options.tabView.height), options: tabViewOptions)
